...
public class ShopApplication {
	...
	/*
	 * @Bean
	 * CommandLineRunner init(UserRepository userRepository, CategoryRepository
	 * categoryRepository,
	 ...
	 * .build();
	 * 
	 * User userAdmin = User.builder().username("ferAdmin").password(new
	 ...
	 * 
	 * User user = User.builder().username("ferUser").password(new
	 * BCryptPasswordEncoder()
	 * .encode("1234")).roles(Set.of(roleUser)).enabled(true)
	 * .accountNonExpired(true)
	 * .accountNonLocked(true).credentialsNonExpired(true).build();
	 * 
	 * User userInvited = User.builder().username("ferInvited").password(new
	 * BCryptPasswordEncoder()
