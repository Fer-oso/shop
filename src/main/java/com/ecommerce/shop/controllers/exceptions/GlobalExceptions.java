...
public class GlobalExceptions {
    ...
    public ResponseEntity<ResponseErrorModel> handleMissingServletRequestPartException(MissingServletRequestPartException missingServletRequestPartException){
    ...
    public ResponseEntity<ResponseErrorModel> handleHttpMediaTypeNotSupportedException(HttpMediaTypeNotSupportedException httpMediaTypeNotSupportedException){
