...
public class ProductControler {
        ...
        public ProductControler(IProductService<ProductDTO> productService) {
        ...
        ResponseEntity<ResponseSuccessModel<ProductDTO>> findProductByName(@PathVariable String productName) {

                return ResponseEntity.status(HttpStatus.OK).body(ResponseSuccessModel.<ProductDTO>builder()
                                .status("OK")
                                .code(200)
                                .response(productService.findByName(productName))
                                .timestamp(LocalDateTime.now())
                                .build());
        }
        ...
        @PreAuthorize("hasRole('ADMIN')")
        @PutMapping("/{id}")
        ResponseEntity<ResponseSuccessModel<ProductDTO>> updateProduct(
                        @Valid @RequestPart("product") ProductDTO productDTO,
                        @RequestPart(name = "image", required = false) List<MultipartFile> images,
        ...
        @DeleteMapping("/{id}")
        ResponseEntity<ResponseSuccessModel<String>> deleteById(@PathVariable Long id) {

                return ResponseEntity.status(HttpStatus.OK).body(ResponseSuccessModel.<String>builder()
                                .status("OK")
                                .code(200)
         ...
         */
        @GetMapping()
        ResponseEntity<ResponseSuccessModel<List<ProductDTO>>> findAll() {
                System.out.println("me ejecute");
                return ResponseEntity.status(HttpStatus.OK).body(ResponseSuccessModel.<List<ProductDTO>>builder()
                                .status("OK")
                                .code(200)
        ...
        @GetMapping("/names")
        ResponseEntity<ResponseSuccessModel<List<ProductDTO>>> findProductsByName(
                        @RequestParam(required = false, defaultValue = "__ALL__") String name) {
                return ResponseEntity.status(HttpStatus.OK)
                                .body(ResponseSuccessModel.<List<ProductDTO>>builder()
                                                .status("OK")
                                                .code(200)
        ...
        @GetMapping("/brand")
        ResponseEntity<ResponseSuccessModel<List<ProductDTO>>> findProductsByBrand(
        ...
        ResponseEntity<ResponseSuccessModel<List<ProductDTO>>> findProductsByCategoryName(
        ...
        ResponseEntity<ResponseSuccessModel<List<ProductDTO>>> findProductsByBrandAndName(@PathVariable String brand,
                        @PathVariable String name) {

                return ResponseEntity.status(HttpStatus.OK).body(ResponseSuccessModel.<List<ProductDTO>>builder()
                                .status("OK")
                                .code(200)
                                .response(productService.findProductsByBrandAndName(brand, name))
                                .timestamp(LocalDateTime.now())
                                .build());
        }
}
